...
Revision ID: 72dae539277d
Revises: 18f0f41a1ccd
Create Date: 2021-04-07 21:02:18.569035
...
def upgrade():
    ...
    op.add_column('user', sa.Column('address1', sa.String(length=80), nullable=True))
    op.add_column('user', sa.Column('address2', sa.String(length=80), nullable=True))
    ...
    op.add_column('user', sa.Column('favorite_activities', sa.String(length=80), nullable=True))
    op.add_column('user', sa.Column('nick_name', sa.String(length=100), nullable=True))
    op.add_column('user', sa.Column('postal_code', sa.String(length=80), nullable=True))
